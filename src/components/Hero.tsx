...
const Hero = () => {
  ...
  return (
    <section id="home" className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-800 flex items-center relative overflow-hidden">
      {/* Animated Background */}
      <div className="absolute inset-0">
        ...
        ></div>
        <div className="absolute top-20 right-20 w-72 h-72 bg-cyan-500/5 rounded-full blur-3xl animate-bounce"></div>
        <div className="absolute bottom-20 left-20 w-80 h-80 bg-blue-600/5 rounded-full blur-3xl animate-pulse"></div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="text-white text-center lg:text-left">            
            <h1 className=" font-black mb-8 leading-tight">
              <span className="text-2xl sm:text-5xl md:text-5xl lg:text-5xl block">WELCOME </span>
              <span className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl bg-gradient-to-r from-blue-400 via-cyan-300 to-blue-300 bg-clip-text text-transparent">
          ...
          <div className="flex justify-center lg:justify-end mt-12 lg:mt-0">
            <div className="relative">
              <div className="w-80 h-80 md:w-99 md:h-96 rounded-full bg-gradient-to-br from-blue-500/20 to-cyan-500/20 backdrop-blur-sm flex items-center justify-center overflow-hidden border-4 border-blue-400/30 shadow-2xl">
                <img 
